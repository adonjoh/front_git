        ...
        <DashboardLayout title="Présences">
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-gray-900 mb-2">Scanner un QR Code</h1>
                    <p className="text-gray-600">Scannez le QR code de l'événement pour valider votre présence et gagner des points.</p>
                </div>

                <div className="bg-white rounded-xl border p-5 shadow-sm overflow-hidden">
                    <div id="reader" className="w-full rounded-lg overflow-hidden border-2 border-indigo-100"></div>
                </div>

                {loading && (
                    <div className="bg-blue-50 text-blue-600 p-4 rounded-xl border border-blue-200 flex items-center justify-center">
